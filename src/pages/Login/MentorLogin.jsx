    ...
    <main className="flex h-[100vh] w-[95%] mx-auto">
      <div className="w-[90%] md:w-[50%]">
        <div className="flex flex-col mx-auto w-[90%] md:w-[70%] my-32">
          <Link to={"/login-guardian"} className="text-right text-primary mb-5">
            Login as a Guardian Instead?
          </Link>
          <div>
            ...
            <p className="text-primary text-sm">
              Login to your mentor account on Blueeprint
            </p>
          </div>
          ...
          <div className="text-primary flex justify-between mx-auto text-sm">
            <p>
              ...
              <Link to={"/signup-mentor"} className="underline">
                {" "}
                Create one
              </Link>{" "}
              <br />
