...
const GuardianDashboardLayout = ({ children }) => {
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="col-span-1">
          <Sidebar
            ...
            linkName={"Mentors"}
            link1={"/guardian-dashboard"}
            link2={"/guardian-dashboard/wards"}
            link3={"/guardian-dashboard/mentors"}
            link4={"/guardian-dashboard/settings"}
            profile={photo}
          />
        </div>
        <motion.div
